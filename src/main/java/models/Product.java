...
public class Product implements Serializable{
	...
	public Product(Long id, String productName, String productDescription, long colorId, long categoryId, double productPrice,
			int productQuantity, LocalDate productDate, LocalTime productTime, byte[] productPhoto,
			String productPhotoName) {
		this.productId = id;
		this.productName = productName;
	...
	public LocalDateTime getDateTime() {
		 LocalDateTime fromDateAndTime = LocalDateTime.of(this.productDate,
				 this.productTime);
