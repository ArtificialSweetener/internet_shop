...
<body>
		...
		<div class="header-right">
			...
			<form action="/MyInternetShop/FrontController" method="post">
				<input type="hidden" id="command" name="command"
					...
					name="pageName" value="admin/add_category.jsp"> <select
	...
	<div class="container">
		<h1 class="text-center pt-3 pb-3">
			<fmt:message key="label.welcomeaddcat" />
		</h1>
					...
					<div class="row g-2">
						<div class="form-group">
							<input type="text" class="textAreaStyle"
								placeholder="<fmt:message key="label.entercattitle"/>"
								name="catTitle" required />
						</div>

						<div class="form-group">
							<textarea style="height: 300px;" class="textAreaStyle"
								placeholder="<fmt:message key="label.entercatdesc"/>"
