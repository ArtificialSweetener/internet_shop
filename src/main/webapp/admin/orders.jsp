		...
		<div class="header-right">
			...
			<form action="/MyInternetShop/FrontController" method="get">
				<input type="hidden" id="command" name="command"
					...
					name="pageName" value="/admin/orders.jsp"> <select id="language"
	...
	<div class="card">
		<div class="card-body">
			<div class="row">
					...
					<tbody>
						<c:forEach items="${allOrdersList}" var="order">
							<tr>
								...
								<td><form action="/MyInternetShop/FrontController" method="post">
										<input type="hidden" id="command" name="command"
				...
				<c:if test="${currentPageAllOrders != null}">
					<nav aria-label="Page navigation example">
						<ul class="pagination justify-content-center">
							<li class="page-item"><c:if
									test="${currentPageAllOrders != 1}">
									<a class="page-link"
										href="/MyInternetShop/FrontController?command=GET_ALL_ORDERS_LIST&page=${currentPageAllOrders - 1}"><fmt:message
						key="label.previous" /></a>
								...
								<c:choose>
									...
									<c:otherwise>
										<li class="page-item"><a class="page-link"
											href="/MyInternetShop/FrontController?command=GET_ALL_ORDERS_LIST&page=${i}">${i}</a>
										</li>
									</c:otherwise>
								</c:choose>
							</c:forEach>
							...
							<li class="page-item"><c:if
									test="${currentPageAllOrders lt noOfPagesAllOrders}">
									<a class="page-link"
										href="/MyInternetShop/FrontController?command=GET_ALL_ORDERS_LIST&page=${currentPageAllOrders + 1}"><fmt:message
						key="label.next" /></a>
								</c:if></li>
