...
<a href="index.jsp"><fmt:message key="label.about" /></a>
			<form action="FrontController" method="post">
				<input type="hidden" id="command" name="command"
					...
					name="pageName" value="users.jsp"> <select id="language"
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-center">
						<li class="page-item"><c:if
								...
								<a class="page-link"
									href="FrontController?command=GET_USERS_LIST&page=${currentPageAllUsers - 1}">Previous</a>
							</c:if></li>
							...
							<c:choose>
								...
								<c:otherwise>
									<li class="page-item"><a class="page-link"
										href="FrontController?command=GET_USERS_LIST&page=${i}">${i}</a>
									</li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						...
						<li class="page-item"><c:if
								...
								<a class="page-link"
									href="FrontController?command=GET_USERS_LIST&page=${currentPageAllUsers + 1}">Next</a>
							</c:if></li>
					</ul>
				</nav>
