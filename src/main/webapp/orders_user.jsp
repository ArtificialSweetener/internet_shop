		...
		<a href="index.jsp"><fmt:message key="label.about" /></a>
			<form action="FrontController" method="post">
				<input type="hidden" id="command" name="command"
					...
					name="pageName" value="orders_user.jsp"> <select id="language"
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-center">
						<li class="page-item"><c:if
								...
								<a class="page-link"
									href="FrontController?command=GET_USER_ORDERS_LIST&page=${currentPageAllUserOrders - 1}">Previous</a>
							</c:if></li>
							...
							<c:choose>
								...
								<c:otherwise>
									<li class="page-item"><a class="page-link"
										href="FrontController?command=GET_USER_ORDERS_LIST&page=${i}">${i}</a>
									</li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						...
						<li class="page-item"><c:if
								...
								<a class="page-link"
									href="FrontController?command=GET_USER_ORDERS_LIST&page=${currentPageAllUserOrders + 1}">Next</a>
							</c:if></li>
					</ul>
				</nav>
