...
<body>
		...
		<a href="index.jsp"><fmt:message key="label.about" /></a>
			<form action="FrontController" method="post">
				<input type="hidden" id="command" name="command"
					...
					name="pageName" value="add_color.jsp"> <select id="language"
	...
	<div class="container">
		<h1 class="text-center pt-3 pb-3">
			<fmt:message key="label.welcomeaddcol" />
		</h1>
	...
	<div class=" row d-flex justify-content-center">
		<div class="card col-md-6 center-block">
			<div class="card-body text-center pt-4 pb-6 c_card">
				...
				<form action="FrontController" method="post">
					<input type="hidden" id="command" name="command" value="ADD_COLOR">
					
					<div class="row g-2">
						<div class="form-group">
							<input type="text" class="textAreaStyle"
								placeholder="<fmt:message key="label.entercolname" />"
