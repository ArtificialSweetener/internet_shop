		...
		<a href="index.jsp"><fmt:message key="label.about" /></a>
			<form action="FrontController" method="post">
				<input type="hidden" id="command" name="command"
					...
					name="pageName" value="register.jsp"> <select id="language"
			...
			<a href="login.jsp"><fmt:message key="label.login" /></a> <a
				class="active" href="register.jsp"><fmt:message
			...
			<div class="col-md-6">
				...
				<form action="FrontController" method="post"
					...
					<div class="form-group">
						...
						<label for="password"><fmt:message key="label.passwordregister" /></label>
						<input type="password"
